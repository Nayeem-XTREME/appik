    ...
    <Wrapper>
      <Flex flexWrap="wrap" pt={37.5}>
        <LogoBox width={[1, 1, 1 / 2, 1 / 3]} pr={[0, 0, 5]}>
          <Link to="/">
            <Image width="98px" marginBottom="28px" src={logo} alt="logo" />
          </Link>
          <Text variant="p" mb={[18, 18, 28]}>
        ...
        >
          <Flex
            ...
            alignItems="center"
            onClick={() => setLinkBox(!linkbox)}
          >
            <Text mr={3} variant="h5">
              Useful Links
            </Text>
            {linkbox ? <Minus /> : <Plus />}
          </Flex>
          ...
          <Flex flexWrap="wrap">
            <Box width={[1, 1, 1 / 2, 1 / 2]}>
              <Ul>
                <Li>
                  <MyLink to="#index">
                    <Text className="footer-link" variant="p">
                      Home
                    </Text>
                  </MyLink>
                </Li>
            ...
            <Box width={[1, 1, 5 / 12, 1]}>
              <Social>
                {social.map((logo, index) => (
                  <SocialLink to={logo.to} key={index}>
                    <SocialLogo
                      width="100%"
                      maxWidth="40px"
                      height="auto"
      ...
      <CopyText variant="p" pb={37.5}>
        Copyright 2021. www.appik.com. All Rights Reserved.
      </CopyText>
    </Wrapper>
  )
}
